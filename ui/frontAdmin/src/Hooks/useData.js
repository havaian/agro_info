export default function useData() {
  const main = [
    ...
    },
    {
      ...
      rules: {
        required: { value: true, message: "Maydonni to'ldiring" },
        minLength: { value: 4, message: "Yilni kiriting. 2022" },
        maxLength: { value: 4, message: "Yilni kiriting. 2022" },
        min: { value: 1900 },
        max: { value: 3000 },
      },
      size: { sm: 12, md: 6, xl: 6 },
    ...
    {
      label: "Tashkil etilganligi bo'yicha qaror",
      name: "qaror",
      type: "text",
      placeholder: "Tashkil etilganligi bo'yicha qaror",
      rules: {
        required: { value: true, message: "Maydonni to'ldiring" },
      },
      size: { sm: 12, md: 6, xl: 6 },
  ...
  const xisobRaqam = [
    ...
    {
      label: "Tijorat banklarida ochilgan xisob raqamlar",
      name: "tijorat_xisob_raqam",
      type: "number",
      placeholder: "Tijorat banklarida ochilgan xisob raqamlar",
      rules: {
        required: { value: true, message: "Maydonni to'ldiring" },
        minLength: {
          value: 0,
  ...
  const asosiy = [
    ...
    {
      label: "Invitro laboratoriya jixozlari (mln.sumda)",
      name: "invinlab",
      type: "number",
      placeholder: "1 000 000",
      rules: {
  ...
  const loyiha = [
    {
      label: "Amalga oshirilayotgan ilmiy loyihalar  (mln.sumda)",
  ...
  const daromad = [
    ...
    {
      label: "Va boshqalar yo'nalishlar (mln.sumda)",
